                ...
                <div className="container">
                    <header className="hero">
                        ...
                        <p className="hero-description animate-fade-in-up animate-delay-200">
                            Companies are stepping away from <span className="leet-text">Leet</span><span className="code-text">Code</span>.
                            Your ability to communicate, write, and draw your thinking matters more than ever.
                        </p>
                    ...
                    <section className="features">
                        <div className="features-grid">
                            ...
                            <div className="feature animate-fade-in-up animate-delay-400 hover-lift">
                                ...
                                <h3>Code & Draw</h3>
                                <p>Explain technical concepts with a code editor and a drawing pad</p>
                            </div>
